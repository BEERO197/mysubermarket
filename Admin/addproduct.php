...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['proadd'])) {
    ...
    if (empty($proname) || empty($proprice) || empty($prosection) || empty($prodescrip) || empty($prosize) || empty($quantity)) {
        ...
        <main>
            <div class="form_product">
                ...
                <form action="addproduct.php" method="POST" enctype="multipart/form-data">
                    ...
                    <br>
                    <button class="button"><a href="../index.php">retun to index</a></button>
                    <button  class="button"><a href="../Admin/adminpanal.php">retun to adminpanal</a></button>
