        ...
        ?>
            <div class="product_card">
                ...
                <div class="product_name">
                    <a href="detalis.php?id=<?php echo $row['id']?>"><?php echo $row['name'];?></a>
                </div>
                <div class="product_price">
                    <a href="detalis.php?id=<?php echo $row['id']?>"><?php echo $row['price'];?> &nbsp; price</a>
                </div>
                <div class="product_discription">
                    <a href="detalis.php?id=<?php echo $row['id']?>"><i class="fa-solid fa-eye"> </i></a> اضغط هنا للمزيد من التفاصيل
                </div>
                <div class="qy_input">
                    <form action="cart1.php?action&id=<?php echo $row['id']; ?>" method="post">
                        <button class="qy_count-mins">-</button>
                        <input type="number" value="1" name="quantity" id="quantity" min="0" max="7" style="width: 40px;">
